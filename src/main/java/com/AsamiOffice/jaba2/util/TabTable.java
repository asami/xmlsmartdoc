 ...
 */
public class TabTable extends AbstractTable {
    public TabTable(String text) {
        super(parseTable(text));
    }

    public TabTable(File file) throws IOException {
    ...
    public static D2Array parseTable(String text) {
        ...
        for (int y = 0; y < list.length; y++) {
            String[] line = UString.makeStringListFromTabLine(list[y]);
