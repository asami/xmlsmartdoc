 ...
 */
public class TItem extends AbstractTTextBox {
...
/*
    ...
    public void format(CPanel cnode) { // XXX : hack
    ...
    // XXX : should layout text
    // via special container instead of CPanal and CRowPanel
