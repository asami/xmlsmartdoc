 ...
 *
 * @since   Aug. 28, 1999
 * @version Oct. 22, 20003
 * @author  ASAMI, Tomoharu (asami@XMLSmartDoc.org)
 */
public class SmartDocResource_en extends AbstractSmartDocResource {
    public SmartDocResource_en() throws IOException {
        super(
            "/org/xmlsmartdoc/SmartDoc/SmartDocDefaults_en.properties",
            "/org/xmlsmartdoc/SmartDoc/messages_en"
        );
    }
