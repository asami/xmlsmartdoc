...
package org.xmlsmartdoc.SmartDoc.dvi;
 ...
 */
public class DVIConfig extends AbstractSmartDocDelegationFormatConfig {
	...
	ParameterInfo info = new AppParameterInfo(
	    ...
	    args,
	    "org.xmlsmartdoc.SmartDoc.dvi.DVIDefaults",
	    new File("SmartDoc.properties")
	);
	info.addPackage("org.xmlsmartdoc.SmartDoc.dvi");
	info.addPackage("org.xmlsmartdoc.SmartDoc.dvi.handler");
	...
	_init(config, "dvi", info, latex2eConfig, latex2eGenerator);
    }
