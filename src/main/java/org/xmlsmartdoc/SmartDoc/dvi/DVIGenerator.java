 ...
 */
public class DVIGenerator extends AbstractSmartDocGenerator {
    protected DVIConfig dviConfig_;
    ...
    public void init(SmartDocConfig config, SmartDocFormatConfig fconfig) {
        ...
        dviConfig_ = (DVIConfig)fconfig;
        latex2eGenerator_
            = (LaTeX2eGenerator)dviConfig_.getDelegationGenerator();
    }
...
*/
            ...
            // Handle external bitmaps
            GeneratorResult finalResult = new GeneratorResult();
            finalResult.addArtifact(
                new LinkArtifact(dviFile.getName(), dviFile.getPath())
            );
/*
            finalResult.addArtifact(
                dviFile.getName(),
