...
/**
 * <b>MMaction</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="maction">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMaction implements java.io.Serializable, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMaction</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMaction(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMaction</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMaction(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMaction</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMaction(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMaction</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMaction</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMaction</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("maction");
        int size;
        if (actiontype != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMactionContent value = (IMMactionContent)this.content.get(i);
    ...
    /**
     * Gets the IMMactionContent property <b>content</b>.
     *
     * @return IMMactionContent[]
     */
    public final IMMactionContent[] getContent() {
        IMMactionContent[] array = new IMMactionContent[content.size()];
        return ((IMMactionContent[])content.toArray(array));
    }

    /**
     * Sets the IMMactionContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMactionContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMactionContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMactionContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMaction</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "maction")) {
            return (false);
        }
     ...
     * is valid for the <code>MMaction</code>.
