...
/**
 * <b>MSec</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="sec">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="sec">
...
public class MSec implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSec</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSec(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSec</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSec(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSec</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSec(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSec</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSec</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSec</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("sec");
        int size;
     ...
     * for the <code>MSec</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "sec")) {
            return (false);
        }
     ...
     * is valid for the <code>MSec</code>.
