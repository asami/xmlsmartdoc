...
/**
 * <b>MMsqrt</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="msqrt">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMsqrt implements java.io.Serializable, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMsqrt</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMsqrt(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMsqrt</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMsqrt(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMsqrt</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMsqrt(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMsqrt</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMsqrt</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMsqrt</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("msqrt");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMsqrtContent value = (IMMsqrtContent)this.content.get(i);
    ...
    /**
     * Gets the IMMsqrtContent property <b>content</b>.
     *
     * @return IMMsqrtContent[]
     */
    public final IMMsqrtContent[] getContent() {
        IMMsqrtContent[] array = new IMMsqrtContent[content.size()];
        return ((IMMsqrtContent[])content.toArray(array));
    }

    /**
     * Sets the IMMsqrtContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMsqrtContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMsqrtContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMsqrtContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMsqrt</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "msqrt")) {
            return (false);
        }
     ...
     * is valid for the <code>MMsqrt</code>.
