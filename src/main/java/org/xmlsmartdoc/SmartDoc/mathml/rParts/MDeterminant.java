...
/**
 * <b>MDeterminant</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="determinant">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="determinant">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="determinant"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="determinant"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
...
public class MDeterminant implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MDeterminant</code>.
     *
     */
    public MDeterminant() {
    }
    ...
    /**
     * Creates a <code>MDeterminant</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MDeterminant(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MDeterminant</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MDeterminant(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MDeterminant</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MDeterminant(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MDeterminant</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MDeterminant</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MDeterminant</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("determinant");
        int size;
     ...
     * for the <code>MDeterminant</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "determinant")) {
            return (false);
        }
     ...
     * is valid for the <code>MDeterminant</code>.
