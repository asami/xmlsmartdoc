...
/**
 * <b>MSinh</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="sinh">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="sinh">
...
public class MSinh implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSinh</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSinh(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSinh</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSinh(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSinh</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSinh(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSinh</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSinh</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSinh</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("sinh");
        int size;
     ...
     * for the <code>MSinh</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "sinh")) {
            return (false);
        }
     ...
     * is valid for the <code>MSinh</code>.
