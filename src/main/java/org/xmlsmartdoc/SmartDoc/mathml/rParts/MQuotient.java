...
/**
 * <b>MQuotient</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="quotient">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="quotient">
...
public class MQuotient implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MQuotient</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MQuotient(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MQuotient</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MQuotient(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MQuotient</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MQuotient(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MQuotient</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MQuotient</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MQuotient</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MQuotient</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "quotient")) {
            return (false);
        }
     ...
     * is valid for the <code>MQuotient</code>.
