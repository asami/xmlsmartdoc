...
/**
 * <b>MMfenced</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mfenced">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMfenced implements java.io.Serializable, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    private String open;
    ...
    /**
     * Creates a <code>MMfenced</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMfenced(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMfenced</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMfenced(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMfenced</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMfenced(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMfenced</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMfenced</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMfenced</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mfenced");
        int size;
        if (open != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMfencedContent value = (IMMfencedContent)this.content.get(i);
    ...
    /**
     * Gets the IMMfencedContent property <b>content</b>.
     *
     * @return IMMfencedContent[]
     */
    public final IMMfencedContent[] getContent() {
        IMMfencedContent[] array = new IMMfencedContent[content.size()];
        return ((IMMfencedContent[])content.toArray(array));
    }

    /**
     * Sets the IMMfencedContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMfencedContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMfencedContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMfencedContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMfenced</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mfenced")) {
            return (false);
        }
     ...
     * is valid for the <code>MMfenced</code>.
