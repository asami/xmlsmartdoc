...
/**
 * <b>MCsch</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="csch">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="csch">
...
public class MCsch implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MCsch</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MCsch(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MCsch</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MCsch(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MCsch</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MCsch(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MCsch</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MCsch</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MCsch</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("csch");
        int size;
     ...
     * for the <code>MCsch</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "csch")) {
            return (false);
        }
     ...
     * is valid for the <code>MCsch</code>.
