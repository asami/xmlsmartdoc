...
/**
 * <b>MVector</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="vector">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 */
public class MVector implements java.io.Serializable, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    private String classValue;
    private String style;
    private String id;
    private String other;
    // List<IMVectorContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MVector</code>.
     *
     */
    public MVector() {
    }
    ...
    /**
     * Creates a <code>MVector</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MVector(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MVector</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MVector(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MVector</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MVector(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MVector</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MVector</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MVector</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("vector");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMVectorContent value = (IMVectorContent)this.content.get(i);
    ...
    /**
     * Gets the IMVectorContent property <b>content</b>.
     *
     * @return IMVectorContent[]
     */
    public final IMVectorContent[] getContent() {
        IMVectorContent[] array = new IMVectorContent[content.size()];
        return ((IMVectorContent[])content.toArray(array));
    }

    /**
     * Sets the IMVectorContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMVectorContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMVectorContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMVectorContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MVector</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "vector")) {
            return (false);
        }
     ...
     * is valid for the <code>MVector</code>.
