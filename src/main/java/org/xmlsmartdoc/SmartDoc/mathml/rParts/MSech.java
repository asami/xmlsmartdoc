...
/**
 * <b>MSech</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="sech">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="sech">
...
public class MSech implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSech</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSech(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSech</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSech(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSech</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSech(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSech</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSech</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSech</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("sech");
        int size;
     ...
     * for the <code>MSech</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "sech")) {
            return (false);
        }
     ...
     * is valid for the <code>MSech</code>.
