...
/**
 * <b>MMn</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MMn implements java.io.Serializable, IRVisitable, IRNode, IMMathContent, IMMrowContent, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMn</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMn(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMn(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMn(Element element) {
        setup(element);
    }
    ...
    /**
     * Initializes the <code>MMn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMn</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mn");
        int size;
        if (fontsize != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMnPCDATA value = (IMMnPCDATA)this.pcdata.get(i);
    ...
    /**
     * Gets the IMMnPCDATA property <b>pcdata</b>.
     *
     * @return IMMnPCDATA[]
     */
    public final IMMnPCDATA[] getPcdata() {
        IMMnPCDATA[] array = new IMMnPCDATA[pcdata.size()];
        return ((IMMnPCDATA[])pcdata.toArray(array));
    }

    /**
     * Sets the IMMnPCDATA property <b>pcdata</b>.
     *
     * @param pcdata
     */
    public final void setPcdata(IMMnPCDATA[] pcdata) {
        this.pcdata.clear();
    ...
    /**
     * Adds the IMMnPCDATA property <b>pcdata</b>.
     *
     * @param pcdata
     */
    public final void addPcdata(IMMnPCDATA pcdata) {
        this.pcdata.add(pcdata);
        pcdata.setParentRNode(this);
    }
     ...
     * for the <code>MMn</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mn")) {
            return (false);
        }
     ...
     * is valid for the <code>MMn</code>.
