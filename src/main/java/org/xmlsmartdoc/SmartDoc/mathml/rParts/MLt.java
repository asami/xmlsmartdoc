...
/**
 * <b>MLt</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MLt implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MLt</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MLt(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MLt</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MLt(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MLt</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MLt(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MLt</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MLt</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MLt</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("lt");
        int size;
     ...
     * for the <code>MLt</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "lt")) {
            return (false);
        }
     ...
     * is valid for the <code>MLt</code>.
