...
/**
 * <b>MMinus</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="minus">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="minus">
 ...
 */
public class MMinus implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMinus</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMinus(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMinus</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMinus(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMinus</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMinus(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMinus</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMinus</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMinus</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("minus");
        int size;
     ...
     * for the <code>MMinus</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "minus")) {
            return (false);
        }
     ...
     * is valid for the <code>MMinus</code>.
