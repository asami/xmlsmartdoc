...
/**
 * <b>MDiff</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="diff">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="diff">
 ...
 */
public class MDiff implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MDiff</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MDiff(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MDiff</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MDiff(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MDiff</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MDiff(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MDiff</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MDiff</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MDiff</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("diff");
        int size;
     ...
     * for the <code>MDiff</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "diff")) {
            return (false);
        }
     ...
     * is valid for the <code>MDiff</code>.
