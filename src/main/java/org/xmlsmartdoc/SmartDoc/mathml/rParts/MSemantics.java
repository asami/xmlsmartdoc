...
/**
 * <b>MSemantics</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="semantics">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="semantics"&gt;
 *   &lt;choice occurs="*"&gt;
 *     &lt;ref label="ci"/&gt;
 *     &lt;ref label="cn"/&gt;
 *     &lt;ref label="apply"/&gt;
...
public class MSemantics implements java.io.Serializable, IMSemanticsContent, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MSemantics</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSemantics(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSemantics</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSemantics(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSemantics</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSemantics(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSemantics</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSemantics</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSemantics</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("semantics");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMSemanticsContent value = (IMSemanticsContent)this.content.get(i);
    ...
    /**
     * Gets the IMSemanticsContent property <b>content</b>.
     *
     * @return IMSemanticsContent[]
     */
    public final IMSemanticsContent[] getContent() {
        IMSemanticsContent[] array = new IMSemanticsContent[content.size()];
        return ((IMSemanticsContent[])content.toArray(array));
    }

    /**
     * Sets the IMSemanticsContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMSemanticsContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMSemanticsContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMSemanticsContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MSemantics</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "semantics")) {
            return (false);
        }
     ...
     * is valid for the <code>MSemantics</code>.
