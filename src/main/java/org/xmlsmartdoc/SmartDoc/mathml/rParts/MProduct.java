...
/**
 * <b>MProduct</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MProduct implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MProduct</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MProduct(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MProduct</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MProduct(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MProduct</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MProduct(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MProduct</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MProduct</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MProduct</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MProduct</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "product")) {
            return (false);
        }
     ...
     * is valid for the <code>MProduct</code>.
