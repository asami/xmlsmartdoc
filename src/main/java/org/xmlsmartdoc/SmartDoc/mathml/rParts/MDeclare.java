...
/**
 * <b>MDeclare</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="declare">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 *   <attribute name="nargs" type="string"/>
 ...
 */
public class MDeclare implements java.io.Serializable, IMDeclareContent, IMSemanticsContent, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    private String type;
    ...
    /**
     * Creates a <code>MDeclare</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MDeclare(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MDeclare</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MDeclare(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MDeclare</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MDeclare(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MDeclare</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MDeclare</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MDeclare</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    private void init(Element element) {
        ...
        scope = URelaxer2.getAttributePropertyAsString(element, "http://www.w3.org/1998/Math/MathML", "scope");
        nargs = URelaxer2.getAttributePropertyAsString(element, "http://www.w3.org/1998/Math/MathML", "nargs");
        occurrence = URelaxer2.getAttributePropertyAsString(element, "http://www.w3.org/1998/Math/MathML", "occurrence");
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("declare");
        int size;
        if (type != null) {
            URelaxer2.setAttributePropertyByString(element, "http://www.w3.org/1998/Math/MathML", "type", type);
        }
        if (scope != null) {
            URelaxer2.setAttributePropertyByString(element, "http://www.w3.org/1998/Math/MathML", "scope", scope);
        }
        if (nargs != null) {
            URelaxer2.setAttributePropertyByString(element, "http://www.w3.org/1998/Math/MathML", "nargs", nargs);
        }
        if (occurrence != null) {
            URelaxer2.setAttributePropertyByString(element, "http://www.w3.org/1998/Math/MathML", "occurrence", occurrence);
        }
        ...
        for (int i = 0;i < size;i++) {
            IMDeclareContent value = (IMDeclareContent)this.content.get(i);
    ...
    /**
     * Gets the String property <b>nargs</b>.
     *
     * @return String
     */
    public final String getNargs() {
        return (nargs);
    }

    /**
     * Sets the String property <b>nargs</b>.
     *
     * @param nargs
     */
    public final void setNargs(String nargs) {
        this.nargs = nargs;
    }

    /**
     * Gets the String property <b>occurrence</b>.
     *
     * @return String
     */
    ...
    /**
     * Sets the String property <b>occurrence</b>.
     *
     * @param occurrence
     */
    public final void setOccurrence(String occurrence) {
    ...
    /**
     * Gets the IMDeclareContent property <b>content</b>.
     *
     * @return IMDeclareContent[]
     */
    public final IMDeclareContent[] getContent() {
        IMDeclareContent[] array = new IMDeclareContent[content.size()];
        return ((IMDeclareContent[])content.toArray(array));
    }

    /**
     * Sets the IMDeclareContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMDeclareContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMDeclareContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMDeclareContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MDeclare</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "declare")) {
            return (false);
        }
     ...
     * is valid for the <code>MDeclare</code>.
