...
/**
 * <b>MExp</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="exp">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="exp">
...
public class MExp implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MExp</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MExp(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MExp</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MExp(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MExp</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MExp(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MExp</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MExp</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MExp</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("exp");
        int size;
     ...
     * for the <code>MExp</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "exp")) {
            return (false);
        }
     ...
     * is valid for the <code>MExp</code>.
