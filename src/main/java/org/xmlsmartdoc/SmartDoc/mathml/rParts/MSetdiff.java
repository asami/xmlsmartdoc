...
/**
 * <b>MSetdiff</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="setdiff">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="setdiff">
...
public class MSetdiff implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSetdiff</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSetdiff(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSetdiff</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSetdiff(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSetdiff</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSetdiff(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSetdiff</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSetdiff</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSetdiff</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("setdiff");
        int size;
     ...
     * for the <code>MSetdiff</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "setdiff")) {
            return (false);
        }
     ...
     * is valid for the <code>MSetdiff</code>.
