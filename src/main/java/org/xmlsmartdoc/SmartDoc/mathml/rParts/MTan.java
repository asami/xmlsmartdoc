...
/**
 * <b>MTan</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="tan">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="tan">
...
public class MTan implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MTan</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MTan(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MTan</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MTan(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MTan</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MTan(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MTan</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MTan</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MTan</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("tan");
        int size;
     ...
     * for the <code>MTan</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "tan")) {
            return (false);
        }
     ...
     * is valid for the <code>MTan</code>.
