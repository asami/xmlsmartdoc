...
/**
 * <b>MCondition</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="condition">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="condition"&gt;
 *   &lt;choice occurs="*"&gt;
 *     &lt;ref label="ci"/&gt;
 *     &lt;ref label="cn"/&gt;
 *     &lt;ref label="apply"/&gt;
 ...
 */
public class MCondition implements java.io.Serializable, IMConditionContent, IMDeclareContent, IMSemanticsContent, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMLambdaContent, IMRelnContent, IMApplyContent {
    private String classValue;
    private String style;
    private String id;
    private String other;
    // List<IMConditionContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MCondition</code>.
     *
     */
    public MCondition() {
    }
    ...
    /**
     * Creates a <code>MCondition</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MCondition(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MCondition</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MCondition(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MCondition</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MCondition(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MCondition</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MCondition</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MCondition</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        for (int i = 0;i < size;i++) {
            IMConditionContent value = (IMConditionContent)this.content.get(i);
    ...
    /**
     * Gets the IMConditionContent property <b>content</b>.
     *
     * @return IMConditionContent[]
     */
    public final IMConditionContent[] getContent() {
        IMConditionContent[] array = new IMConditionContent[content.size()];
        return ((IMConditionContent[])content.toArray(array));
    }

    /**
     * Sets the IMConditionContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMConditionContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMConditionContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMConditionContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MCondition</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "condition")) {
            return (false);
        }
     ...
     * is valid for the <code>MCondition</code>.
