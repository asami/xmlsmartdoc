...
/**
 * <b>MMprescripts</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mprescripts">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="mprescripts">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="mprescripts"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="mprescripts"&gt;
 *   &lt;attribute name="class" type="string"/&gt;
 ...
 */
public class MMprescripts implements java.io.Serializable, IRVisitable, IRNode, IMMrowContent, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent {
    ...
    /**
     * Creates a <code>MMprescripts</code>.
     *
     */
    public MMprescripts() {
    }
    ...
    /**
     * Creates a <code>MMprescripts</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMprescripts(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMprescripts</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMprescripts(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMprescripts</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMprescripts(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMprescripts</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMprescripts</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMprescripts</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mprescripts");
        int size;
        if (classValue != null) {
     ...
     * for the <code>MMprescripts</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mprescripts")) {
            return (false);
        }
     ...
     * is valid for the <code>MMprescripts</code>.
