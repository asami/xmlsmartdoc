...
/**
 * <b>MMode</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mode">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="mode">
 ...
 */
public class MMode implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMode</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMode(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMode</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMode(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMode</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMode(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMode</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMode</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMode</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mode");
        int size;
     ...
     * for the <code>MMode</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mode")) {
            return (false);
        }
     ...
     * is valid for the <code>MMode</code>.
