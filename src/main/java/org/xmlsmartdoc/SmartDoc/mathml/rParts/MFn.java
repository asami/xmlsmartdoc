...
/**
 * <b>MFn</b> is generated by Relaxer based on MathML.rlx.
...
public class MFn implements java.io.Serializable, IMFnContent, IRVisitable, IRNode, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MFn</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MFn(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MFn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MFn(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MFn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MFn(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MFn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MFn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MFn</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("fn");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMFnContent value = (IMFnContent)this.content.get(i);
    ...
    /**
     * Gets the IMFnContent property <b>content</b>.
     *
     * @return IMFnContent[]
     */
    public final IMFnContent[] getContent() {
        IMFnContent[] array = new IMFnContent[content.size()];
        return ((IMFnContent[])content.toArray(array));
    }

    /**
     * Sets the IMFnContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMFnContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMFnContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMFnContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MFn</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "fn")) {
            return (false);
        }
     ...
     * is valid for the <code>MFn</code>.
