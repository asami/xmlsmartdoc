...
/**
 * <b>MMpadded</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mpadded">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMpadded implements java.io.Serializable, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMpadded</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMpadded(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMpadded</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMpadded(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMpadded</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMpadded(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMpadded</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMpadded</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMpadded</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    private void init(Element element) {
        ...
        depth = URelaxer2.getAttributePropertyAsString(element, "http://www.w3.org/1998/Math/MathML", "depth");
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mpadded");
        int size;
        if (width != null) {
        ...
        if (depth != null) {
            URelaxer2.setAttributePropertyByString(element, "http://www.w3.org/1998/Math/MathML", "depth", depth);
        }
        if (lspace != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMpaddedContent value = (IMMpaddedContent)this.content.get(i);
    ...
    /**
     * Gets the String property <b>depth</b>.
     *
     * @return String
     */
    ...
    /**
     * Sets the String property <b>depth</b>.
     *
     * @param depth
     */
    ...
    /**
     * Gets the IMMpaddedContent property <b>content</b>.
     *
     * @return IMMpaddedContent[]
     */
    public final IMMpaddedContent[] getContent() {
        IMMpaddedContent[] array = new IMMpaddedContent[content.size()];
        return ((IMMpaddedContent[])content.toArray(array));
    }

    /**
     * Sets the IMMpaddedContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMpaddedContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMpaddedContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMpaddedContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMpadded</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mpadded")) {
            return (false);
        }
     ...
     * is valid for the <code>MMpadded</code>.
