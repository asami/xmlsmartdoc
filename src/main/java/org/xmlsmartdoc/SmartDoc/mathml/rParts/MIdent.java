...
/**
 * <b>MIdent</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="ident">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="ident">
...
public class MIdent implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MIdent</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MIdent(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MIdent</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MIdent(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MIdent</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MIdent(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MIdent</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MIdent</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MIdent</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MIdent</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "ident")) {
            return (false);
        }
     ...
     * is valid for the <code>MIdent</code>.
