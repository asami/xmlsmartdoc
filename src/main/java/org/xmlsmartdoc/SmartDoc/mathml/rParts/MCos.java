...
/**
 * <b>MCos</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="cos">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="cos">
...
public class MCos implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MCos</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MCos(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MCos</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MCos(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MCos</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MCos(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MCos</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MCos</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MCos</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("cos");
        int size;
     ...
     * for the <code>MCos</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "cos")) {
            return (false);
        }
     ...
     * is valid for the <code>MCos</code>.
