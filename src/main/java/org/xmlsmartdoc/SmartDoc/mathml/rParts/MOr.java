...
/**
 * <b>MOr</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MOr implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MOr</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MOr(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MOr</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MOr(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MOr</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MOr(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MOr</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MOr</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MOr</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MOr</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "or")) {
            return (false);
        }
     ...
     * is valid for the <code>MOr</code>.
