...
/**
 * <b>MMsub</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="msub">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMsub implements java.io.Serializable, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMsub</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMsub(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMsub</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMsub(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMsub</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMsub(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMsub</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMsub</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMsub</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("msub");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMMsubContent value = (IMMsubContent)this.content.get(i);
    ...
    /**
     * Gets the IMMsubContent property <b>content</b>.
     *
     * @return IMMsubContent[]
     */
    public final IMMsubContent[] getContent() {
        IMMsubContent[] array = new IMMsubContent[content.size()];
        return ((IMMsubContent[])content.toArray(array));
    }

    /**
     * Sets the IMMsubContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMsubContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMsubContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMsubContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMsub</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "msub")) {
            return (false);
        }
     ...
     * is valid for the <code>MMsub</code>.
