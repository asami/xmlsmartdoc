...
/**
 * <b>MApply</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="apply">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
...
public class MApply implements java.io.Serializable, IMApplyContent, IMRelnContent, IMLambdaContent, IMConditionContent, IMDeclareContent, IMSemanticsContent, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MApply</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MApply(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MApply</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MApply(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MApply</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MApply(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MApply</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MApply</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MApply</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("apply");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMApplyContent value = (IMApplyContent)this.content.get(i);
    ...
    /**
     * Gets the IMApplyContent property <b>content</b>.
     *
     * @return IMApplyContent[]
     */
    public final IMApplyContent[] getContent() {
        IMApplyContent[] array = new IMApplyContent[content.size()];
        return ((IMApplyContent[])content.toArray(array));
    }

    /**
     * Sets the IMApplyContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMApplyContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMApplyContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMApplyContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MApply</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "apply")) {
            return (false);
        }
     ...
     * is valid for the <code>MApply</code>.
