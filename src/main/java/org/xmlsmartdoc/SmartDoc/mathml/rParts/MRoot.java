...
/**
 * <b>MRoot</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="root">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="root">
 ...
 */
public class MRoot implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MRoot</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MRoot(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MRoot</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MRoot(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MRoot</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MRoot(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MRoot</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MRoot</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MRoot</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MRoot</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "root")) {
            return (false);
        }
     ...
     * is valid for the <code>MRoot</code>.
