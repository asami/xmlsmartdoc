...
/**
 * <b>MMsubsup</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="msubsup">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMsubsup implements java.io.Serializable, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMsubsup</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMsubsup(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMsubsup</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMsubsup(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMsubsup</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMsubsup(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMsubsup</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMsubsup</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMsubsup</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("msubsup");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMMsubsupContent value = (IMMsubsupContent)this.content.get(i);
    ...
    /**
     * Gets the IMMsubsupContent property <b>content</b>.
     *
     * @return IMMsubsupContent[]
     */
    public final IMMsubsupContent[] getContent() {
        IMMsubsupContent[] array = new IMMsubsupContent[content.size()];
        return ((IMMsubsupContent[])content.toArray(array));
    }

    /**
     * Sets the IMMsubsupContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMsubsupContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMsubsupContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMsubsupContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMsubsup</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "msubsup")) {
            return (false);
        }
     ...
     * is valid for the <code>MMsubsup</code>.
