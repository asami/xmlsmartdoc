...
/**
 * <b>MMunderover</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="munderover">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="munderover"&gt;
 *   &lt;choice occurs="*"&gt;
 *     &lt;ref label="mi"/&gt;
 *     &lt;ref label="mn"/&gt;
 *     &lt;ref label="mo"/&gt;
 ...
 */
public class MMunderover implements java.io.Serializable, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMunderover</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMunderover(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMunderover</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMunderover(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMunderover</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMunderover(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMunderover</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMunderover</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMunderover</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("munderover");
        int size;
        if (accent != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMunderoverContent value = (IMMunderoverContent)this.content.get(i);
    ...
    /**
     * Gets the IMMunderoverContent property <b>content</b>.
     *
     * @return IMMunderoverContent[]
     */
    public final IMMunderoverContent[] getContent() {
        IMMunderoverContent[] array = new IMMunderoverContent[content.size()];
        return ((IMMunderoverContent[])content.toArray(array));
    }

    /**
     * Sets the IMMunderoverContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMunderoverContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMunderoverContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMunderoverContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMunderover</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "munderover")) {
            return (false);
        }
     ...
     * is valid for the <code>MMunderover</code>.
