...
/**
 * <b>MMrow</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mrow">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMrow implements java.io.Serializable, IMMrowContent, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMathContent {
    ...
    /**
     * Creates a <code>MMrow</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMrow(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMrow</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMrow(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMrow</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMrow(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMrow</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMrow</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMrow</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mrow");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMrowContent value = (IMMrowContent)this.content.get(i);
    ...
    /**
     * Gets the IMMrowContent property <b>content</b>.
     *
     * @return IMMrowContent[]
     */
    public final IMMrowContent[] getContent() {
        IMMrowContent[] array = new IMMrowContent[content.size()];
        return ((IMMrowContent[])content.toArray(array));
    }

    /**
     * Sets the IMMrowContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMrowContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMrowContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMrowContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMrow</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mrow")) {
            return (false);
        }
     ...
     * is valid for the <code>MMrow</code>.
