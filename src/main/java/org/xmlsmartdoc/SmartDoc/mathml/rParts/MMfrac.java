...
/**
 * <b>MMfrac</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mfrac">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMfrac implements java.io.Serializable, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMfrac</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMfrac(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMfrac</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMfrac(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMfrac</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMfrac(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMfrac</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMfrac</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMfrac</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mfrac");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMMfracContent value = (IMMfracContent)this.content.get(i);
    ...
    /**
     * Gets the IMMfracContent property <b>content</b>.
     *
     * @return IMMfracContent[]
     */
    public final IMMfracContent[] getContent() {
        IMMfracContent[] array = new IMMfracContent[content.size()];
        return ((IMMfracContent[])content.toArray(array));
    }

    /**
     * Sets the IMMfracContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMfracContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMfracContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMfracContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMfrac</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mfrac")) {
            return (false);
        }
     ...
     * is valid for the <code>MMfrac</code>.
