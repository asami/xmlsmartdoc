...
/**
 * <b>MIn</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MIn implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MIn</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MIn(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MIn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MIn(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MIn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MIn(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MIn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MIn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MIn</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MIn</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "in")) {
            return (false);
        }
     ...
     * is valid for the <code>MIn</code>.
