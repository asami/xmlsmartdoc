...
/**
 * <b>MNotprsubset</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="notprsubset">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="notprsubset">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="notprsubset"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="notprsubset"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
 ...
 * </pre>
 *
 * @version MathML.rlx 1.0 (Sat Sep 09 10:48:48 JST 2000)
 * @author  Relaxer 0.11b (by ASAMI@Yokohama)
 */
public class MNotprsubset implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MNotprsubset</code>.
     *
     */
    public MNotprsubset() {
    }
    ...
    /**
     * Creates a <code>MNotprsubset</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MNotprsubset(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MNotprsubset</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MNotprsubset(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MNotprsubset</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MNotprsubset(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MNotprsubset</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MNotprsubset</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MNotprsubset</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("notprsubset");
        int size;
     ...
     * for the <code>MNotprsubset</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "notprsubset")) {
            return (false);
        }
     ...
     * is valid for the <code>MNotprsubset</code>.
