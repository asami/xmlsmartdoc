...
/**
 * <b>MEq</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MEq implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MEq</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MEq(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MEq</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MEq(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MEq</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MEq(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MEq</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MEq</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MEq</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("eq");
        int size;
     ...
     * for the <code>MEq</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "eq")) {
            return (false);
        }
     ...
     * is valid for the <code>MEq</code>.
