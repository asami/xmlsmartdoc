...
/**
 * <b>MSet</b> is generated by Relaxer based on MathML.rlx.
...
public class MSet implements java.io.Serializable, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MSet</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSet(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSet</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSet(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSet</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSet(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSet</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSet</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSet</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * is valid for the <code>MSet</code>.
