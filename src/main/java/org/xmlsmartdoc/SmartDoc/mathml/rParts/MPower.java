...
/**
 * <b>MPower</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="power">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="power">
...
public class MPower implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MPower</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MPower(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MPower</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MPower(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MPower</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MPower(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MPower</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MPower</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MPower</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("power");
        int size;
     ...
     * for the <code>MPower</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "power")) {
            return (false);
        }
     ...
     * is valid for the <code>MPower</code>.
