...
/**
 * <b>MMalignmark</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="malignmark">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="malignmark">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="malignmark"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="malignmark"&gt;
 *   &lt;attribute name="edge" type="NMTOKEN"&gt;
...
public class MMalignmark implements java.io.Serializable, IRVisitable, IRNode, IMMiPCDATA, IMMnPCDATA, IMMoPCDATA, IMMtextPCDATA, IMMsPCDATA, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMalignmark</code>.
     *
     */
    public MMalignmark() {
    }
    ...
    /**
     * Creates a <code>MMalignmark</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMalignmark(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMalignmark</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMalignmark(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMalignmark</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMalignmark(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMalignmark</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMalignmark</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMalignmark</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("malignmark");
        int size;
        if (edge != null) {
     ...
     * for the <code>MMalignmark</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "malignmark")) {
            return (false);
        }
     ...
     * is valid for the <code>MMalignmark</code>.
