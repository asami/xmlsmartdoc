...
/**
 * <b>MMunder</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="munder">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMunder implements java.io.Serializable, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    private String accentunder;
    private String classValue;
    private String style;
    private String id;
    private String other;
    // List<IMMunderContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MMunder</code>.
     *
     */
    public MMunder() {
    }
    ...
    /**
     * Creates a <code>MMunder</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMunder(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMunder</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMunder(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMunder</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMunder(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMunder</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMunder</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMunder</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("munder");
        int size;
        if (accentunder != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMunderContent value = (IMMunderContent)this.content.get(i);
    ...
    /**
     * Gets the IMMunderContent property <b>content</b>.
     *
     * @return IMMunderContent[]
     */
    public final IMMunderContent[] getContent() {
        IMMunderContent[] array = new IMMunderContent[content.size()];
        return ((IMMunderContent[])content.toArray(array));
    }

    /**
     * Sets the IMMunderContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMunderContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMunderContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMunderContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMunder</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "munder")) {
            return (false);
        }
     ...
     * is valid for the <code>MMunder</code>.
