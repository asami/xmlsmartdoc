...
/**
 * <b>MMover</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mover">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMover implements java.io.Serializable, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMover</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMover(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMover</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMover(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMover</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMover(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMover</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMover</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMover</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mover");
        int size;
        if (accent != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMoverContent value = (IMMoverContent)this.content.get(i);
    ...
    /**
     * Gets the IMMoverContent property <b>content</b>.
     *
     * @return IMMoverContent[]
     */
    public final IMMoverContent[] getContent() {
        IMMoverContent[] array = new IMMoverContent[content.size()];
        return ((IMMoverContent[])content.toArray(array));
    }

    /**
     * Sets the IMMoverContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMoverContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMoverContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMoverContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMover</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mover")) {
            return (false);
        }
     ...
     * is valid for the <code>MMover</code>.
