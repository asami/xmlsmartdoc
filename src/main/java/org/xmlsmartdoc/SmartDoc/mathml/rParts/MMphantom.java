...
/**
 * <b>MMphantom</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mphantom">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMphantom implements java.io.Serializable, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    private String classValue;
    private String style;
    private String id;
    private String other;
    // List<IMMphantomContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MMphantom</code>.
     *
     */
    public MMphantom() {
    }
    ...
    /**
     * Creates a <code>MMphantom</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMphantom(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMphantom</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMphantom(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMphantom</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMphantom(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMphantom</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMphantom</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMphantom</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mphantom");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMphantomContent value = (IMMphantomContent)this.content.get(i);
    ...
    /**
     * Gets the IMMphantomContent property <b>content</b>.
     *
     * @return IMMphantomContent[]
     */
    public final IMMphantomContent[] getContent() {
        IMMphantomContent[] array = new IMMphantomContent[content.size()];
        return ((IMMphantomContent[])content.toArray(array));
    }

    /**
     * Sets the IMMphantomContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMphantomContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMphantomContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMphantomContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMphantom</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mphantom")) {
            return (false);
        }
     ...
     * is valid for the <code>MMphantom</code>.
