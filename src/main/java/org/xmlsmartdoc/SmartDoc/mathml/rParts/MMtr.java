...
/**
 * <b>MMtr</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mtr">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
...
public class MMtr implements java.io.Serializable, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMtr</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMtr(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMtr</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMtr(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMtr</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMtr(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMtr</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMtr</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMtr</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mtr");
        int size;
        if (rowalign != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMtrContent value = (IMMtrContent)this.content.get(i);
    ...
    /**
     * Gets the IMMtrContent property <b>content</b>.
     *
     * @return IMMtrContent[]
     */
    public final IMMtrContent[] getContent() {
        IMMtrContent[] array = new IMMtrContent[content.size()];
        return ((IMMtrContent[])content.toArray(array));
    }

    /**
     * Sets the IMMtrContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMtrContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMtrContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMtrContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMtr</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mtr")) {
            return (false);
        }
     ...
     * is valid for the <code>MMtr</code>.
