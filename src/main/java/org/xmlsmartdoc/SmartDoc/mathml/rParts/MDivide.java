...
/**
 * <b>MDivide</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="divide">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="divide">
...
public class MDivide implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MDivide</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MDivide(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MDivide</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MDivide(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MDivide</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MDivide(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MDivide</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MDivide</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MDivide</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("divide");
        int size;
     ...
     * for the <code>MDivide</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "divide")) {
            return (false);
        }
     ...
     * is valid for the <code>MDivide</code>.
