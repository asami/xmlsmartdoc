...
/**
 * <b>MUnion</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="union">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="union">
 ...
 */
public class MUnion implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MUnion</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MUnion(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MUnion</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MUnion(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MUnion</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MUnion(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MUnion</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MUnion</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MUnion</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("union");
        int size;
     ...
     * for the <code>MUnion</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "union")) {
            return (false);
        }
     ...
     * is valid for the <code>MUnion</code>.
