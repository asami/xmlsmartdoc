...
public final class URelaxer2 {
	...
	if (value == null || "".equals(value)) { // by horst.fiedler@tifff.com
	    if (!"".equals(getAttribute(element, namespaceURI, localName))) {
	...
	String value = getAttribute(element, namespaceURI, attrName);
	return (!value.equals(""));
    }
	...
	String elementURI = element.getNamespaceURI();
	if (elementURI != null) {
	    return (element.getAttributeNS(namespaceURI, attrName));
	} else {
