...
/**
 * <b>MUplimit</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="uplimit">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
...
public class MUplimit implements java.io.Serializable, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MUplimit</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MUplimit(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MUplimit</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MUplimit(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MUplimit</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MUplimit(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MUplimit</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MUplimit</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MUplimit</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("uplimit");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMUplimitContent value = (IMUplimitContent)this.content.get(i);
    ...
    /**
     * Gets the IMUplimitContent property <b>content</b>.
     *
     * @return IMUplimitContent[]
     */
    public final IMUplimitContent[] getContent() {
        IMUplimitContent[] array = new IMUplimitContent[content.size()];
        return ((IMUplimitContent[])content.toArray(array));
    }

    /**
     * Sets the IMUplimitContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMUplimitContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMUplimitContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMUplimitContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MUplimit</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "uplimit")) {
            return (false);
        }
     ...
     * is valid for the <code>MUplimit</code>.
