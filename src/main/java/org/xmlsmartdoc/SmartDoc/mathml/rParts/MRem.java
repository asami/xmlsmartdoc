...
/**
 * <b>MRem</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="rem">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="rem">
...
public class MRem implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MRem</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MRem(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MRem</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MRem(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MRem</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MRem(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MRem</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MRem</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MRem</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * is valid for the <code>MRem</code>.
