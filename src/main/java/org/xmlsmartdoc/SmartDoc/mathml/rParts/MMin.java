...
/**
 * <b>MMin</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="min">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="min">
 ...
 */
public class MMin implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMin</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMin(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMin</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMin(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMin</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMin(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMin</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMin</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMin</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("min");
        int size;
     ...
     * for the <code>MMin</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "min")) {
            return (false);
        }
     ...
     * is valid for the <code>MMin</code>.
