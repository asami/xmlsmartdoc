...
/**
 * <b>MLowlimit</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="lowlimit">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 */
public class MLowlimit implements java.io.Serializable, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    private String classValue;
    private String style;
    private String id;
    private String other;
    // List<IMLowlimitContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MLowlimit</code>.
     *
     */
    public MLowlimit() {
    }
    ...
    /**
     * Creates a <code>MLowlimit</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MLowlimit(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MLowlimit</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MLowlimit(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MLowlimit</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MLowlimit(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MLowlimit</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MLowlimit</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MLowlimit</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("lowlimit");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMLowlimitContent value = (IMLowlimitContent)this.content.get(i);
    ...
    /**
     * Gets the IMLowlimitContent property <b>content</b>.
     *
     * @return IMLowlimitContent[]
     */
    public final IMLowlimitContent[] getContent() {
        IMLowlimitContent[] array = new IMLowlimitContent[content.size()];
        return ((IMLowlimitContent[])content.toArray(array));
    }

    /**
     * Sets the IMLowlimitContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMLowlimitContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMLowlimitContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMLowlimitContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MLowlimit</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "lowlimit")) {
            return (false);
        }
     ...
     * is valid for the <code>MLowlimit</code>.
