...
/**
 * <b>MGt</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MGt implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MGt</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MGt(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MGt</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MGt(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MGt</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MGt(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MGt</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MGt</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MGt</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("gt");
        int size;
     ...
     * for the <code>MGt</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "gt")) {
            return (false);
        }
     ...
     * is valid for the <code>MGt</code>.
