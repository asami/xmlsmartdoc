...
/**
 * <b>MMatrix</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="matrix">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
...
public class MMatrix implements java.io.Serializable, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMatrix</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMatrix(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMatrix</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMatrix(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMatrix</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMatrix(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMatrix</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMatrix</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMatrix</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("matrix");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMatrixContent value = (IMMatrixContent)this.content.get(i);
    ...
    /**
     * Gets the IMMatrixContent property <b>content</b>.
     *
     * @return IMMatrixContent[]
     */
    public final IMMatrixContent[] getContent() {
        IMMatrixContent[] array = new IMMatrixContent[content.size()];
        return ((IMMatrixContent[])content.toArray(array));
    }

    /**
     * Sets the IMMatrixContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMatrixContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMatrixContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMatrixContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMatrix</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "matrix")) {
            return (false);
        }
     ...
     * is valid for the <code>MMatrix</code>.
