...
/**
 * <b>MNot</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="not">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="not">
...
public class MNot implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MNot</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MNot(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MNot</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MNot(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MNot</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MNot(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MNot</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MNot</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MNot</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MNot</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "not")) {
            return (false);
        }
     ...
     * is valid for the <code>MNot</code>.
