...
/**
 * <b>MSdev</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="sdev">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="sdev">
 ...
 */
public class MSdev implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSdev</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSdev(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSdev</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSdev(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSdev</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSdev(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSdev</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSdev</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSdev</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("sdev");
        int size;
     ...
     * for the <code>MSdev</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "sdev")) {
            return (false);
        }
     ...
     * is valid for the <code>MSdev</code>.
