...
/**
 * <b>MMs</b> is generated by Relaxer based on MathML.rlx.
 ...
 */
public class MMs implements java.io.Serializable, IRVisitable, IRNode, IMMathContent, IMMrowContent, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMs</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMs(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMs</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMs(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMs</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMs(Element element) {
        setup(element);
    }
    ...
    /**
     * Initializes the <code>MMs</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMs</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMs</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("ms");
        int size;
        if (fontsize != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMsPCDATA value = (IMMsPCDATA)this.pcdata.get(i);
    ...
    /**
     * Gets the IMMsPCDATA property <b>pcdata</b>.
     *
     * @return IMMsPCDATA[]
     */
    public final IMMsPCDATA[] getPcdata() {
        IMMsPCDATA[] array = new IMMsPCDATA[pcdata.size()];
        return ((IMMsPCDATA[])pcdata.toArray(array));
    }

    /**
     * Sets the IMMsPCDATA property <b>pcdata</b>.
     *
     * @param pcdata
     */
    public final void setPcdata(IMMsPCDATA[] pcdata) {
        this.pcdata.clear();
    ...
    /**
     * Adds the IMMsPCDATA property <b>pcdata</b>.
     *
     * @param pcdata
     */
    public final void addPcdata(IMMsPCDATA pcdata) {
        this.pcdata.add(pcdata);
        pcdata.setParentRNode(this);
    }
     ...
     * for the <code>MMs</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "ms")) {
            return (false);
        }
     ...
     * is valid for the <code>MMs</code>.
