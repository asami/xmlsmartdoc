...
/**
 * <b>MFactorial</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="factorial">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="factorial">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="factorial"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="factorial"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
...
public class MFactorial implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MFactorial</code>.
     *
     */
    public MFactorial() {
    }
    ...
    /**
     * Creates a <code>MFactorial</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MFactorial(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MFactorial</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MFactorial(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MFactorial</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MFactorial(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MFactorial</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MFactorial</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MFactorial</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("factorial");
        int size;
     ...
     * for the <code>MFactorial</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "factorial")) {
            return (false);
        }
     ...
     * is valid for the <code>MFactorial</code>.
