...
/**
 * <b>MNotsubset</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="notsubset">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="notsubset">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="notsubset"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="notsubset"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
 ...
 */
public class MNotsubset implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MNotsubset</code>.
     *
     */
    public MNotsubset() {
    }
    ...
    /**
     * Creates a <code>MNotsubset</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MNotsubset(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MNotsubset</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MNotsubset(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MNotsubset</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MNotsubset(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MNotsubset</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MNotsubset</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MNotsubset</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("notsubset");
        int size;
     ...
     * for the <code>MNotsubset</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "notsubset")) {
            return (false);
        }
     ...
     * is valid for the <code>MNotsubset</code>.
