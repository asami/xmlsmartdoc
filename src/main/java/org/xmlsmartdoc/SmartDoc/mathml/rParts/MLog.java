...
/**
 * <b>MLog</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="log">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="log">
 ...
 */
public class MLog implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MLog</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MLog(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MLog</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MLog(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MLog</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MLog(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MLog</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MLog</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MLog</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MLog</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "log")) {
            return (false);
        }
     ...
     * is valid for the <code>MLog</code>.
