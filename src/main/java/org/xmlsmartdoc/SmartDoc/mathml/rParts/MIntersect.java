...
/**
 * <b>MIntersect</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="intersect">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="intersect">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="intersect"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="intersect"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
 ...
 */
public class MIntersect implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MIntersect</code>.
     *
     */
    public MIntersect() {
    }
    ...
    /**
     * Creates a <code>MIntersect</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MIntersect(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MIntersect</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MIntersect(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MIntersect</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MIntersect(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MIntersect</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MIntersect</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MIntersect</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("intersect");
        int size;
     ...
     * for the <code>MIntersect</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "intersect")) {
            return (false);
        }
     ...
     * is valid for the <code>MIntersect</code>.
