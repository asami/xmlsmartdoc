...
/**
 * <b>MMsup</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="msup">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMsup implements java.io.Serializable, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMsup</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMsup(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMsup</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMsup(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMsup</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMsup(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMsup</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMsup</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMsup</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("msup");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMMsupContent value = (IMMsupContent)this.content.get(i);
    ...
    /**
     * Gets the IMMsupContent property <b>content</b>.
     *
     * @return IMMsupContent[]
     */
    public final IMMsupContent[] getContent() {
        IMMsupContent[] array = new IMMsupContent[content.size()];
        return ((IMMsupContent[])content.toArray(array));
    }

    /**
     * Sets the IMMsupContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMsupContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMsupContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMsupContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMsup</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "msup")) {
            return (false);
        }
     ...
     * is valid for the <code>MMsup</code>.
