...
/**
 * <b>MSep</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="sep">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="sep">
 ...
 */
public class MSep implements java.io.Serializable, IRVisitable, IRNode, IMCnPCDATA, IMDeclareContent, IMSemanticsContent, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSep</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSep(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSep</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSep(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSep</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSep(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSep</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSep</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSep</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("sep");
        int size;
        if (classValue != null) {
     ...
     * for the <code>MSep</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "sep")) {
            return (false);
        }
     ...
     * is valid for the <code>MSep</code>.
