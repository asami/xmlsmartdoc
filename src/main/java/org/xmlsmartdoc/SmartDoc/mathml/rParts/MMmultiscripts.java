...
/**
 * <b>MMmultiscripts</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mmultiscripts">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="mmultiscripts"&gt;
 *   &lt;choice occurs="*"&gt;
 *     &lt;ref label="mi"/&gt;
 *     &lt;ref label="mn"/&gt;
 *     &lt;ref label="mo"/&gt;
 ...
 */
public class MMmultiscripts implements java.io.Serializable, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    // List<IMMmultiscriptsContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MMmultiscripts</code>.
     *
     */
    public MMmultiscripts() {
    }

    /**
     * Creates a <code>MMmultiscripts</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMmultiscripts(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMmultiscripts</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMmultiscripts(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMmultiscripts</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMmultiscripts(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMmultiscripts</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMmultiscripts</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMmultiscripts</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mmultiscripts");
        int size;
        ...
        for (int i = 0;i < size;i++) {
            IMMmultiscriptsContent value = (IMMmultiscriptsContent)this.content.get(i);
    ...
    /**
     * Gets the IMMmultiscriptsContent property <b>content</b>.
     *
     * @return IMMmultiscriptsContent[]
     */
    public final IMMmultiscriptsContent[] getContent() {
        IMMmultiscriptsContent[] array = new IMMmultiscriptsContent[content.size()];
        return ((IMMmultiscriptsContent[])content.toArray(array));
    }

    /**
     * Sets the IMMmultiscriptsContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMmultiscriptsContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMmultiscriptsContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMmultiscriptsContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMmultiscripts</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mmultiscripts")) {
            return (false);
        }
     ...
     * is valid for the <code>MMmultiscripts</code>.
