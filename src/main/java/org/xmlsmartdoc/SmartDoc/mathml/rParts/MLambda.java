...
/**
 * <b>MLambda</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="lambda">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
...
public class MLambda implements java.io.Serializable, IMLambdaContent, IMConditionContent, IMDeclareContent, IMSemanticsContent, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MLambda</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MLambda(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MLambda</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MLambda(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MLambda</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MLambda(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MLambda</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MLambda</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MLambda</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("lambda");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMLambdaContent value = (IMLambdaContent)this.content.get(i);
    ...
    /**
     * Gets the IMLambdaContent property <b>content</b>.
     *
     * @return IMLambdaContent[]
     */
    public final IMLambdaContent[] getContent() {
        IMLambdaContent[] array = new IMLambdaContent[content.size()];
        return ((IMLambdaContent[])content.toArray(array));
    }

    /**
     * Sets the IMLambdaContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMLambdaContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMLambdaContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMLambdaContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MLambda</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "lambda")) {
            return (false);
        }
     ...
     * is valid for the <code>MLambda</code>.
