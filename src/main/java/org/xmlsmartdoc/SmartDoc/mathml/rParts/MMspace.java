...
/**
 * <b>MMspace</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mspace">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="mspace">
 ...
 */
public class MMspace implements java.io.Serializable, IRVisitable, IRNode, IMMathContent, IMMrowContent, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMspace</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMspace(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMspace</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMspace(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMspace</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMspace(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMspace</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMspace</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMspace</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mspace");
        int size;
        if (width != null) {
     ...
     * for the <code>MMspace</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mspace")) {
            return (false);
        }
     ...
     * is valid for the <code>MMspace</code>.
