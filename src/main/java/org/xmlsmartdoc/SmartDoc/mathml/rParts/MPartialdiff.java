...
/**
 * <b>MPartialdiff</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="partialdiff">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="partialdiff">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="partialdiff"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="partialdiff"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
 ...
 */
public class MPartialdiff implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MPartialdiff</code>.
     *
     */
    public MPartialdiff() {
    }
    ...
    /**
     * Creates a <code>MPartialdiff</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MPartialdiff(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MPartialdiff</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MPartialdiff(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MPartialdiff</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MPartialdiff(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MPartialdiff</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MPartialdiff</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MPartialdiff</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("partialdiff");
        int size;
     ...
     * for the <code>MPartialdiff</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "partialdiff")) {
            return (false);
        }
     ...
     * is valid for the <code>MPartialdiff</code>.
