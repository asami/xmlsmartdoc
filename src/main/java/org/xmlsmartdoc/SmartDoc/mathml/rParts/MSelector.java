...
/**
 * <b>MSelector</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="selector">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="selector">
 ...
 */
public class MSelector implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSelector</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSelector(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSelector</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSelector(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSelector</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSelector(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSelector</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSelector</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSelector</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MSelector</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "selector")) {
            return (false);
        }
     ...
     * is valid for the <code>MSelector</code>.
