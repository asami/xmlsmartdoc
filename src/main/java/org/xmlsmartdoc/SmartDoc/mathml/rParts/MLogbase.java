...
/**
 * <b>MLogbase</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="logbase">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
...
public class MLogbase implements java.io.Serializable, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MLogbase</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MLogbase(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MLogbase</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MLogbase(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MLogbase</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MLogbase(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MLogbase</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MLogbase</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MLogbase</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("logbase");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMLogbaseContent value = (IMLogbaseContent)this.content.get(i);
    ...
    /**
     * Gets the IMLogbaseContent property <b>content</b>.
     *
     * @return IMLogbaseContent[]
     */
    public final IMLogbaseContent[] getContent() {
        IMLogbaseContent[] array = new IMLogbaseContent[content.size()];
        return ((IMLogbaseContent[])content.toArray(array));
    }

    /**
     * Sets the IMLogbaseContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMLogbaseContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMLogbaseContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMLogbaseContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MLogbase</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "logbase")) {
            return (false);
        }
     ...
     * is valid for the <code>MLogbase</code>.
