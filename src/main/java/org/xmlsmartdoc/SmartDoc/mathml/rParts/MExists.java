...
/**
 * <b>MExists</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="exists">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="exists">
 ...
 */
public class MExists implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MExists</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MExists(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MExists</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MExists(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MExists</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MExists(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MExists</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MExists</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MExists</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * for the <code>MExists</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "exists")) {
            return (false);
        }
     ...
     * is valid for the <code>MExists</code>.
