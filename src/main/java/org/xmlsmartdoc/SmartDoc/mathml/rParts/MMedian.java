...
/**
 * <b>MMedian</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="median">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="median">
 ...
 */
public class MMedian implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMedian</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMedian(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMedian</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMedian(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMedian</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMedian(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMedian</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMedian</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMedian</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("median");
        int size;
     ...
     * for the <code>MMedian</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "median")) {
            return (false);
        }
     ...
     * is valid for the <code>MMedian</code>.
