...
/**
 * <b>MAnnotationXml</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="annotation-xml">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="annotation-xml"&gt;
 *   &lt;choice occurs="*"&gt;
 *     &lt;ref label="ci"/&gt;
 *     &lt;ref label="cn"/&gt;
 *     &lt;ref label="apply"/&gt;
 ...
 */
public class MAnnotationXml implements java.io.Serializable, IMAnnotationXmlContent, IMIntervalContent, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    private String encoding;
    private String classValue;
    private String style;
    private String id;
    private String other;
    // List<IMAnnotationXmlContent>
    private java.util.List content = new java.util.ArrayList();
    private IRNode parentRNode;

    /**
     * Creates a <code>MAnnotationXml</code>.
     *
     */
    public MAnnotationXml() {
    }

    /**
     * Creates a <code>MAnnotationXml</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MAnnotationXml(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MAnnotationXml</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MAnnotationXml(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MAnnotationXml</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MAnnotationXml(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MAnnotationXml</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MAnnotationXml</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MAnnotationXml</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("annotation-xml");
        int size;
        if (encoding != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMAnnotationXmlContent value = (IMAnnotationXmlContent)this.content.get(i);
    ...
    /**
     * Gets the IMAnnotationXmlContent property <b>content</b>.
     *
     * @return IMAnnotationXmlContent[]
     */
    public final IMAnnotationXmlContent[] getContent() {
        IMAnnotationXmlContent[] array = new IMAnnotationXmlContent[content.size()];
        return ((IMAnnotationXmlContent[])content.toArray(array));
    }

    /**
     * Sets the IMAnnotationXmlContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMAnnotationXmlContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMAnnotationXmlContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMAnnotationXmlContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MAnnotationXml</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "annotation-xml")) {
            return (false);
        }
     ...
     * is valid for the <code>MAnnotationXml</code>.
