...
/**
 * <b>MArcsin</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="arcsin">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="arcsin">
...
public class MArcsin implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MArcsin</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MArcsin(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MArcsin</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MArcsin(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MArcsin</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MArcsin(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MArcsin</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MArcsin</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MArcsin</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("arcsin");
        int size;
     ...
     * for the <code>MArcsin</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "arcsin")) {
            return (false);
        }
     ...
     * is valid for the <code>MArcsin</code>.
