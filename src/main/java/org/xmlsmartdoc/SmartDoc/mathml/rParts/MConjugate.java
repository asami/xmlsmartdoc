...
/**
 * <b>MConjugate</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="conjugate">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="conjugate">
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="conjugate"&gt;
 *   &lt;empty/&gt;
 * &lt;/elementRule&gt;
 * &lt;tag name="conjugate"&gt;
 *   &lt;attribute name="definitionURL" type="string"/&gt;
...
public class MConjugate implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MConjugate</code>.
     *
     */
    public MConjugate() {
    }
    ...
    /**
     * Creates a <code>MConjugate</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MConjugate(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MConjugate</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MConjugate(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MConjugate</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MConjugate(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MConjugate</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MConjugate</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MConjugate</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("conjugate");
        int size;
     ...
     * for the <code>MConjugate</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "conjugate")) {
            return (false);
        }
     ...
     * is valid for the <code>MConjugate</code>.
