...
/**
 * <b>MList</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="list">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
...
public class MList implements java.io.Serializable, IMListContent, IMMatrixContent, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MList</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MList(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MList</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MList(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MList</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MList(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MList</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MList</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MList</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    private void init(Element element) {
        ...
        order = URelaxer2.getAttributePropertyAsString(element, "http://www.w3.org/1998/Math/MathML", "order");
    ...
    public void makeElement(Node parent) {
        ...
        int size;
        if (order != null) {
            URelaxer2.setAttributePropertyByString(element, "http://www.w3.org/1998/Math/MathML", "order", order);
        }
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMListContent value = (IMListContent)this.content.get(i);
    ...
    /**
     * Gets the IMListContent property <b>content</b>.
     *
     * @return IMListContent[]
     */
    public final IMListContent[] getContent() {
        IMListContent[] array = new IMListContent[content.size()];
        return ((IMListContent[])content.toArray(array));
    }

    /**
     * Sets the IMListContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMListContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMListContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMListContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MList</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "list")) {
            return (false);
        }
     ...
     * is valid for the <code>MList</code>.
