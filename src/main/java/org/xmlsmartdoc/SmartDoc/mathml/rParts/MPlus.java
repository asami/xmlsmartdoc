...
/**
 * <b>MPlus</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="plus">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="plus">
...
public class MPlus implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MPlus</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MPlus(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MPlus</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MPlus(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MPlus</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MPlus(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MPlus</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MPlus</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MPlus</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("plus");
        int size;
     ...
     * for the <code>MPlus</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "plus")) {
            return (false);
        }
     ...
     * is valid for the <code>MPlus</code>.
