...
/**
 * <b>MBvar</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="bvar">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 */
public class MBvar implements java.io.Serializable, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MBvar</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MBvar(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MBvar</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MBvar(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MBvar</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MBvar(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MBvar</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MBvar</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MBvar</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("bvar");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMBvarContent value = (IMBvarContent)this.content.get(i);
    ...
    /**
     * Gets the IMBvarContent property <b>content</b>.
     *
     * @return IMBvarContent[]
     */
    public final IMBvarContent[] getContent() {
        IMBvarContent[] array = new IMBvarContent[content.size()];
        return ((IMBvarContent[])content.toArray(array));
    }

    /**
     * Sets the IMBvarContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMBvarContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMBvarContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMBvarContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MBvar</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "bvar")) {
            return (false);
        }
     ...
     * is valid for the <code>MBvar</code>.
