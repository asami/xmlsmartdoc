...
/**
 * <b>MMoment</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="moment">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="moment">
 ...
 */
public class MMoment implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MMoment</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMoment(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMoment</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMoment(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMoment</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMoment(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMoment</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMoment</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMoment</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("moment");
        int size;
     ...
     * for the <code>MMoment</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "moment")) {
            return (false);
        }
     ...
     * is valid for the <code>MMoment</code>.
