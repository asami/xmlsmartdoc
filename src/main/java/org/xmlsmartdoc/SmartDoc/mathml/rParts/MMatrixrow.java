...
/**
 * <b>MMatrixrow</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="matrixrow">
 *   <choice occurs="*">
 *     <ref label="ci"/>
 *     <ref label="cn"/>
 *     <ref label="apply"/>
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;elementRule role="matrixrow"&gt;
 *   &lt;choice occurs="*"&gt;
 *     &lt;ref label="ci"/&gt;
 *     &lt;ref label="cn"/&gt;
 *     &lt;ref label="apply"/&gt;
...
public class MMatrixrow implements java.io.Serializable, IMMatrixrowContent, IMSetContent, IMVectorContent, IMLowlimitContent, IMUplimitContent, IMBvarContent, IMDegreeContent, IMLogbaseContent, IMFnContent, IRVisitable, IRNode, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IMMactionContent, IMMtdContent, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMatrixrow</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMatrixrow(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMatrixrow</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMatrixrow(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMatrixrow</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMatrixrow(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMatrixrow</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMatrixrow</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMatrixrow</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("matrixrow");
        int size;
        if (classValue != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMatrixrowContent value = (IMMatrixrowContent)this.content.get(i);
    ...
    /**
     * Gets the IMMatrixrowContent property <b>content</b>.
     *
     * @return IMMatrixrowContent[]
     */
    public final IMMatrixrowContent[] getContent() {
        IMMatrixrowContent[] array = new IMMatrixrowContent[content.size()];
        return ((IMMatrixrowContent[])content.toArray(array));
    }

    /**
     * Sets the IMMatrixrowContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMatrixrowContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMatrixrowContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMatrixrowContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMatrixrow</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "matrixrow")) {
            return (false);
        }
     ...
     * is valid for the <code>MMatrixrow</code>.
