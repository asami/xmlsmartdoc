...
/**
 * <b>MForall</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="forall">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="forall">
 ...
 */
public class MForall implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MForall</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MForall(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MForall</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MForall(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MForall</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MForall(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MForall</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MForall</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MForall</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("forall");
        int size;
     ...
     * for the <code>MForall</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "forall")) {
            return (false);
        }
     ...
     * is valid for the <code>MForall</code>.
