...
/**
 * <b>MNotin</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="notin">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="notin">
 ...
 */
public class MNotin implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MNotin</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MNotin(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MNotin</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MNotin(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MNotin</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MNotin(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MNotin</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MNotin</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MNotin</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("notin");
        int size;
     ...
     * for the <code>MNotin</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "notin")) {
            return (false);
        }
     ...
     * is valid for the <code>MNotin</code>.
