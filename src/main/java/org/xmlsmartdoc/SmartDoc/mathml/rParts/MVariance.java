...
/**
 * <b>MVariance</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="variance">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="variance">
 ...
 */
public class MVariance implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MVariance</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MVariance(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MVariance</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MVariance(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MVariance</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MVariance(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MVariance</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MVariance</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MVariance</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("variance");
        int size;
     ...
     * for the <code>MVariance</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "variance")) {
            return (false);
        }
     ...
     * is valid for the <code>MVariance</code>.
