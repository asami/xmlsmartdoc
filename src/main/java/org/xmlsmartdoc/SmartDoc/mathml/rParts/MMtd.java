...
/**
 * <b>MMtd</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="mtd">
 *   <choice occurs="*">
 *     <ref label="mi"/>
 *     <ref label="mn"/>
 *     <ref label="mo"/>
 ...
 */
public class MMtd implements java.io.Serializable, IMMtdContent, IMMactionContent, IMCiPCDATA, IMCnPCDATA, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent, IRVisitable, IRNode, IMMtrContent, IMMtableContent, IMMmultiscriptsContent, IMMunderoverContent, IMMoverContent, IMMunderContent, IMMsubsupContent, IMMsupContent, IMMsubContent, IMMfencedContent, IMMphantomContent, IMMpaddedContent, IMMerrorContent, IMMstyleContent, IMMrootContent, IMMsqrtContent, IMMfracContent, IMMrowContent, IMMathContent {
    ...
    /**
     * Creates a <code>MMtd</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MMtd(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MMtd</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MMtd(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MMtd</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MMtd(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MMtd</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MMtd</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MMtd</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("mtd");
        int size;
        if (rowalign != null) {
        ...
        for (int i = 0;i < size;i++) {
            IMMtdContent value = (IMMtdContent)this.content.get(i);
    ...
    /**
     * Gets the IMMtdContent property <b>content</b>.
     *
     * @return IMMtdContent[]
     */
    public final IMMtdContent[] getContent() {
        IMMtdContent[] array = new IMMtdContent[content.size()];
        return ((IMMtdContent[])content.toArray(array));
    }

    /**
     * Sets the IMMtdContent property <b>content</b>.
     *
     * @param content
     */
    public final void setContent(IMMtdContent[] content) {
        this.content.clear();
    ...
    /**
     * Adds the IMMtdContent property <b>content</b>.
     *
     * @param content
     */
    public final void addContent(IMMtdContent content) {
        this.content.add(content);
        content.setParentRNode(this);
    }
     ...
     * for the <code>MMtd</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "mtd")) {
            return (false);
        }
     ...
     * is valid for the <code>MMtd</code>.
