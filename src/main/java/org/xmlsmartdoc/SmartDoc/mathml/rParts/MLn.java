...
/**
 * <b>MLn</b> is generated by Relaxer based on MathML.rlx.
...
public class MLn implements java.io.Serializable, IRVisitable, IRNode, IMLogbaseContent, IMFnContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MLn</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MLn(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MLn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MLn(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MLn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MLn(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MLn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MLn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MLn</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("ln");
        int size;
     ...
     * for the <code>MLn</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "ln")) {
            return (false);
        }
     ...
     * is valid for the <code>MLn</code>.
