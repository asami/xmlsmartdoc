...
/**
 * <b>MNone</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="none">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="none">
 ...
 */
public class MNone implements java.io.Serializable, IRVisitable, IRNode, IMMrowContent, IMMfracContent, IMMsqrtContent, IMMrootContent, IMMstyleContent, IMMerrorContent, IMMpaddedContent, IMMphantomContent, IMMfencedContent, IMMsubContent, IMMsupContent, IMMsubsupContent, IMMunderContent, IMMoverContent, IMMunderoverContent, IMMmultiscriptsContent, IMMtableContent, IMMtrContent, IMMtdContent, IMMactionContent {
    ...
    /**
     * Creates a <code>MNone</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MNone(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MNone</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MNone(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MNone</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MNone(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MNone</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MNone</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MNone</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("none");
        int size;
        if (classValue != null) {
     ...
     * for the <code>MNone</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "none")) {
            return (false);
        }
     ...
     * is valid for the <code>MNone</code>.
