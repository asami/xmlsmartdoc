...
/**
 * <b>MSubset</b> is generated by Relaxer based on MathML.rlx.
 * This class is derived from:
 * 
 * <!-- for programmer
 * <elementRule role="subset">
 *   <empty/>
 * </elementRule>
 * 
 * <tag name="subset">
 ...
 */
public class MSubset implements java.io.Serializable, IRVisitable, IRNode, IMFnContent, IMLogbaseContent, IMDegreeContent, IMBvarContent, IMUplimitContent, IMLowlimitContent, IMVectorContent, IMSetContent, IMMatrixrowContent, IMMatrixContent, IMListContent, IMIntervalContent, IMAnnotationXmlContent, IMSemanticsContent, IMDeclareContent, IMConditionContent, IMLambdaContent, IMRelnContent, IMApplyContent {
    ...
    /**
     * Creates a <code>MSubset</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public MSubset(RStack stack) {
        setup(stack);
    }

    /**
     * Creates a <code>MSubset</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    public MSubset(Document doc) {
        setup(doc.getDocumentElement());
    }

    /**
     * Creates a <code>MSubset</code> by the Element <code>element</code>.
     *
     * @param element
     */
    public MSubset(Element element) {
        setup(element);
    }

    /**
     * Initializes the <code>MSubset</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>MSubset</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>MSubset</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("subset");
        int size;
     ...
     * for the <code>MSubset</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer2.isTargetElement(element, "http://www.w3.org/1998/Math/MathML", "subset")) {
            return (false);
        }
     ...
     * is valid for the <code>MSubset</code>.
