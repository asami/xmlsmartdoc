...
import com.AsamiOffice.jaba2.j2fw.J2Resource;

/**
 * AbstractSmartDocResource
 *
 * @since   Aug. 15, 1999
 * @version Apr.  5, 2001
 * @author  ASAMI, Tomoharu (asami@zeomtech.com)
 */
public abstract class AbstractSmartDocResource
    extends J2Resource implements ISmartDocResource {

    protected MessageMap messages_;

    protected AbstractSmartDocResource(
	String property,
	String messages
    ) throws IOException {
	super(
	    SmartDoc.class.getResource(property),
	    SmartDoc.class.getResource(messages)
	);
    }
