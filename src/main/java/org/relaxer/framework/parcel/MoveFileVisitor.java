 ...
 */
public class MoveFileVisitor extends ParcelNodeVisitorBase {
    private File targetDir_;
    private IParcelNodeFilter filter_;
    private Map nameVariables_;

    public MoveFileVisitor(File targetDir) {
        targetDir_ = targetDir;
        filter_ = null;
    }

    public MoveFileVisitor(File targetDir, IParcelNodeFilter filter) {
        targetDir_ = targetDir;
        filter_ = filter;
    }
