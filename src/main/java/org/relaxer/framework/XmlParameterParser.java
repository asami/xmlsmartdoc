 ...
 */
public class XmlParameterParser extends AbstractParameterParser {
    public XmlParameterParser(File file) {
    }

    public XmlParameterParser(Map frameworkProperties) {
        _setFrameworkProperties(frameworkProperties);
    }
    
    public XmlParameterParser(Map frameworkProperties, Map properties) {
