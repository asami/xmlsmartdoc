...
public interface IAccountTableView {
    /**
     * @return boolean
     */
    boolean getJdbc2();
     ...
     * @return RAccount[]
     */
    RAccount[] select() throws SQLException;
     ...
     * @return RAccount[]
     */
    RAccount[] select(String where) throws SQLException;
     ...
     * @return Document
     */
    Document getByNameAsDocument(String name) throws SQLException;
     ...
     * @return RAccount
     */
    RAccount getByName(String name) throws SQLException;
     ...
     * @return RAccount[]
     */
    RAccount[] selectByExpression(String expression) throws SQLException;
     ...
     * @return AccountList
     */
    AccountList selectAsList() throws SQLException;
     ...
     * @return AccountList
     */
    AccountList selectAsList(String where) throws SQLException;
     ...
     * @return AccountList
     */
    AccountList selectByExpressionAsList(String expression) throws SQLException;
}
