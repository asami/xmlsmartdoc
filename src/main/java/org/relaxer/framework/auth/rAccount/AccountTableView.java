...
public class AccountTableView implements IAccountTableView {
    ...
    /**
     * Creates a <code>AccountTableView</code>.
     *
     * @param url
     * @param selectClause
     * @exception SQLException
     */
    public AccountTableView(String url, String selectClause) throws SQLException {
     ...
     * @exception SQLException
     */
    public AccountTableView(String url, String selectClause, String username, String password) throws SQLException {
     ...
     * @exception SQLException
     */
    public AccountTableView(String url, String selectClause, java.util.Properties properties) throws SQLException {
        conn_ = DriverManager.getConnection(url, properties);
        selectClause_ = selectClause;
    }

    /**
     * Creates a <code>AccountTableView</code> by a Connection.
     *
     * @param connection
     * @param selectClause
     */
    public AccountTableView(Connection connection, String selectClause) {
        conn_ = connection;
        selectClause_ = selectClause;
    }
