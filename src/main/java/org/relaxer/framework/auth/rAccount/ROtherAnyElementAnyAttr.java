...
/**
 * <b>ROtherAnyElementAnyAttr</b> is generated from account.rng by Relaxer.
 ...
 */
public class ROtherAnyElementAnyAttr implements java.io.Serializable, Cloneable, IRNSContainer, IRNode, IROtherAnyElementMixed, IROtherAnyElementMixedChoice {
    ...
    /**
     * Creates a <code>ROtherAnyElementAnyAttr</code>.
     *
     */
    public ROtherAnyElementAnyAttr() {
    }
     ...
     * @param source
     */
    public ROtherAnyElementAnyAttr(ROtherAnyElementAnyAttr source) {
        setup(source);
    }

    /**
     * Creates a <code>ROtherAnyElementAnyAttr</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public ROtherAnyElementAnyAttr(RStack stack) {
        setup(stack);
    }

    /**
     * Initializes the <code>ROtherAnyElementAnyAttr</code> by the ROtherAnyElementAnyAttr <code>source</code>.
     *
     * @param source
     */
    public void setup(ROtherAnyElementAnyAttr source) {
        int size;
        setContent(source.getContent());
    }

    /**
     * Initializes the <code>ROtherAnyElementAnyAttr</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     */
    public Object clone() {
        return (new ROtherAnyElementAnyAttr(this));
    }
     ...
     * is valid for the <code>ROtherAnyElementAnyAttr</code>.
