 ...
 */
public class TreeWorkspaceModel extends AbstractRTreeModel {
    public TreeWorkspaceModel() throws RModelException {
        super(NullModelContext.getContext());
    }

    public TreeWorkspaceModel(IRModelContext context) throws RModelException {
		super(context);
	}

/*
	protected void _open_tree() throws RModelException {
        _root = new WorkspaceNode(this);
    }
*/

    protected IRTreeModelNode _newNode(String name) throws RModelException {
        return (new WorkspaceNode(this, name));
    }
