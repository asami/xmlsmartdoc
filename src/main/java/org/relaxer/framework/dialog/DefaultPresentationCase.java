...
/**
 * DefaultPresentationCase
 *
 * @since   May. 12, 2003
 * @version Dec. 29, 2003
 * @author  ASAMI, Tomoharu (asami@relaxer.org)
 */
public class DefaultPresentationCase extends AbstractPresentationCase {
    private FCScene fcScene_;
    private FCDialog fcDialog_;

    public DefaultPresentationCase(FCScene fcScene, FCDialog fcDialog) {
        fcScene_ = fcScene;
        fcDialog_ = fcDialog;
    }

    public FCScene getFcScene() {
        return (fcScene_);
    }
