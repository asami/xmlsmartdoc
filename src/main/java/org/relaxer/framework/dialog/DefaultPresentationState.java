 ...
 */
public class DefaultPresentationState extends AbstractPresentationState {
    private Map map_ = new HashMap();

    public DefaultPresentationState() {
    }

    public void addState(String key, Object value) {
        //System.out.println("addState:" + key + "," + value);
        map_.put(key, value);
    }

    public int getStateCount() {
        return (map_.keySet().size());
    }
