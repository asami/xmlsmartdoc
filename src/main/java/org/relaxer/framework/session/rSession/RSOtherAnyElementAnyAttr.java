...
/**
 * <b>RSOtherAnyElementAnyAttr</b> is generated from session.rng by Relaxer.
 ...
 */
public class RSOtherAnyElementAnyAttr implements java.io.Serializable, Cloneable, IRNSContainer, IRNode, IRSOtherAnyElementMixed, IRSOtherAnyElementMixedChoice {
    ...
    /**
     * Creates a <code>RSOtherAnyElementAnyAttr</code>.
     *
     */
    public RSOtherAnyElementAnyAttr() {
    }
     ...
     * @param source
     */
    public RSOtherAnyElementAnyAttr(RSOtherAnyElementAnyAttr source) {
        setup(source);
    }

    /**
     * Creates a <code>RSOtherAnyElementAnyAttr</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public RSOtherAnyElementAnyAttr(RStack stack) {
        setup(stack);
    }

    /**
     * Initializes the <code>RSOtherAnyElementAnyAttr</code> by the RSOtherAnyElementAnyAttr <code>source</code>.
     *
     * @param source
     */
    public void setup(RSOtherAnyElementAnyAttr source) {
        int size;
        setContent(source.getContent());
    }

    /**
     * Initializes the <code>RSOtherAnyElementAnyAttr</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     */
    public Object clone() {
        return (new RSOtherAnyElementAnyAttr(this));
    }
     ...
     * is valid for the <code>RSOtherAnyElementAnyAttr</code>.
