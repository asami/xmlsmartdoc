...
/**
 * <b>RSAnyAnyAttr</b> is generated from session.rng by Relaxer.
 ...
 */
public class RSAnyAnyAttr implements java.io.Serializable, Cloneable, IRNSContainer, IRNode, IRSAnyMixed, IRSAnyMixedChoice {
    ...
    /**
     * Creates a <code>RSAnyAnyAttr</code>.
     *
     */
    public RSAnyAnyAttr() {
    }
     ...
     * @param source
     */
    public RSAnyAnyAttr(RSAnyAnyAttr source) {
        setup(source);
    }

    /**
     * Creates a <code>RSAnyAnyAttr</code> by the Stack <code>stack</code>
     ...
     * @param stack
     */
    public RSAnyAnyAttr(RStack stack) {
        setup(stack);
    }

    /**
     * Initializes the <code>RSAnyAnyAttr</code> by the RSAnyAnyAttr <code>source</code>.
     *
     * @param source
     */
    public void setup(RSAnyAnyAttr source) {
        int size;
        setContent(source.getContent());
    }

    /**
     * Initializes the <code>RSAnyAnyAttr</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
     ...
     * is valid for the <code>RSAnyAnyAttr</code>.
