...
/**
 * <b>TSValueElementAnyAttr</b> is generated from testScript.rng by Relaxer.
 ...
 */
public class TSValueElementAnyAttr implements java.io.Serializable, Cloneable, IREvaluatable, IRNode, ITSValueElementMixed, ITSValueElementMixedChoice {
    ...
    /**
     * Creates a <code>TSValueElementAnyAttr</code>.
     *
     */
    public TSValueElementAnyAttr() {
    }
     ...
     * @param source
     */
    public TSValueElementAnyAttr(TSValueElementAnyAttr source) {
        setup(source);
    }
     ...
     * @param stack
     */
    public TSValueElementAnyAttr(RStack stack) {
        setup(stack);
    }

    /**
     * Initializes the <code>TSValueElementAnyAttr</code> by the TSValueElementAnyAttr <code>source</code>.
     *
     * @param source
     */
    public void setup(TSValueElementAnyAttr source) {
        int size;
        setContent(source.getContent());
    }

    /**
     * Initializes the <code>TSValueElementAnyAttr</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public Object clone() {
        ...
        return (factory.createTSValueElementAnyAttr(this));
    }
     ...
     * is valid for the <code>TSValueElementAnyAttr</code>.
