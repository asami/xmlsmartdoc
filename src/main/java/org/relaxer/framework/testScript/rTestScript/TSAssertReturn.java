...
/**
 * <b>TSAssertReturn</b> is generated from testScript.rng by Relaxer.
 ...
 * -->
 * <!-- for javadoc -->
 * <pre> &lt;element name="assert-return"&gt;
 *   &lt;ref name="valueExpression"/&gt;
 * &lt;/element&gt;
 * </pre>
 *
 ...
 */
public class TSAssertReturn implements java.io.Serializable, Cloneable, IREvaluatable, IRNode, ITSExpressionMixed, ITSExpressionMixedChoice {
     ...
     * @param source
     */
    public TSAssertReturn(TSAssertReturn source) {
        setup(source);
    }
     ...
     * @param stack
     */
    public TSAssertReturn(RStack stack) {
        setup(stack);
    }
     ...
     * @param doc
     */
    public TSAssertReturn(Document doc) {
     ...
     * @param element
     */
    public TSAssertReturn(Element element) {
        setup(element);
    }
     ...
     */
    public TSAssertReturn(File file) throws IOException, SAXException, ParserConfigurationException {
        setup(file);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TSAssertReturn(String uri) throws IOException, SAXException, ParserConfigurationException {
        setup(uri);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TSAssertReturn(URL url) throws IOException, SAXException, ParserConfigurationException {
        setup(url);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TSAssertReturn(InputStream in) throws IOException, SAXException, ParserConfigurationException {
        setup(in);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TSAssertReturn(InputSource is) throws IOException, SAXException, ParserConfigurationException {
        setup(is);
    }
     ...
     * @exception ParserConfigurationException
     */
    public TSAssertReturn(Reader reader) throws IOException, SAXException, ParserConfigurationException {
        setup(reader);
    }

    /**
     * Initializes the <code>TSAssertReturn</code> by the TSAssertReturn <code>source</code>.
     *
     * @param source
     */
    public void setup(TSAssertReturn source) {
        int size;
        setValueExpression((ITSValueExpressionChoice)source.getValueExpression().clone());
    }

    /**
     * Initializes the <code>TSAssertReturn</code> by the Document <code>doc</code>.
     *
     * @param doc
     */
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the Element <code>element</code>.
     *
     * @param element
     */
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the Stack <code>stack</code>
     * that contains Elements.
     * This constructor is supposed to be used internally
     * by the Relaxer system.
     *
    ...
    public Object clone() {
        ITestScriptFactory factory = TestScriptFactory.getFactory();
        return (factory.createTSAssertReturn(this));
    }
    ...
    public void makeElement(Node parent) {
        ...
        Element element = doc.createElement("assert-return");
        int size;
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the File <code>file</code>.
     *
     * @param file
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>TSAssertReturn</code>
     * by the String representation of URI <code>uri</code>.
     *
     * @param uri
     * @exception IOException
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the URL <code>url</code>.
     *
     * @param url
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the InputStream <code>in</code>.
     *
     * @param in
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the InputSource <code>is</code>.
     *
     * @param is
     * @exception IOException
     * @exception SAXException
    ...
    /**
     * Initializes the <code>TSAssertReturn</code> by the Reader <code>reader</code>.
     *
     * @param reader
     * @exception IOException
     * @exception SAXException
     ...
     * for the <code>TSAssertReturn</code>.
     *
     * @param element
     * @return boolean
     */
    public static boolean isMatch(Element element) {
        if (!URelaxer.isTargetElement(element, "assert-return")) {
            return (false);
        }
     ...
     * is valid for the <code>TSAssertReturn</code>.
